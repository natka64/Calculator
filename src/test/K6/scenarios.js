...
export let options = {
  scenarios: {
    my_scenario: {
      ...
      stages: [
        { duration: '20s', target: 5 },   // Phase 1: Ramp-up to 50 VUs
        { duration: '20s', target: 10 },  // Phase 2: Ramp-up to 100 VUs
        { duration: '15s', target: 10 },  // Phase 3: Hold at 100 VUs
        { duration: '15s', target: 10 },  // Phase 4: Hold at 100 VUs
